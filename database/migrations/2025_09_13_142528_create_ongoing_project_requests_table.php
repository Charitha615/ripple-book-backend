...
return new class extends Migration
{
    public function up()
    {
        Schema::create('ongoing_project_requests', function (Blueprint $table) {
            $table->id();
            ...
            // Project Details
            $table->text('work_types'); // Types of work they can contribute
    ...
    {
        Schema::dropIfExists('ongoing_project_requests');
    }
};
